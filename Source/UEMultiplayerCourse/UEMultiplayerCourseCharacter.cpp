...
//////////////////////////////////////////////////////////////////////////
// AUEMultiplayerCourseCharacter

AUEMultiplayerCourseCharacter::AUEMultiplayerCourseCharacter()
{
...
void AUEMultiplayerCourseCharacter::BeginPlay()
{
	// Call the base class  
	Super::BeginPlay();
}
...
void AUEMultiplayerCourseCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent))
	{
		...
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this,
		                                   &AUEMultiplayerCourseCharacter::Move);

		// Looking
		EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered, this,
		                                   &AUEMultiplayerCourseCharacter::Look);
	}
	else
	{
...
void AUEMultiplayerCourseCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void AUEMultiplayerCourseCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void AUEMultiplayerCourseCharacter::ServerRPCTest_Implementation(int MyArg)
{
	if (HasAuthority())
	{
		...
		if (StaticMeshActor)
		{
			...
			// Have to set mobility to movables
			StaticMeshActor->SetMobility(EComponentMobility::Movable);

			// Set the location of the mesh actor
			StaticMeshActor->SetActorLocation(
				GetActorLocation() + GetActorForwardVector() * 100.0f + GetActorUpVector() * 50.0f);

			// Configure the mesh component
			UStaticMeshComponent* StaticMeshComponent = StaticMeshActor->GetStaticMeshComponent();
			if (StaticMeshComponent)
			{
				// Set replication for the mesh component, otherwise it won't replicate
